...
public class PhotonBrickValidatorVisitor extends AbstractBrickValidatorVisitor implements IPhotonVisitor<Void> {

    public PhotonBrickValidatorVisitor(ConfigurationAst brickConfiguration, ClassToInstanceMap<IProjectBean.IBuilder<?>> beanBuilders) {
