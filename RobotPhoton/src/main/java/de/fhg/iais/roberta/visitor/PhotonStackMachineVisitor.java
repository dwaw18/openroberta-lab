...
public class PhotonStackMachineVisitor<V> extends AbstractStackMachineVisitor<V> implements IPhotonVisitor<V> {

    public PhotonStackMachineVisitor(ConfigurationAst configuration, List<List<Phrase<Void>>> phrases, ILanguage language) {
        super(configuration);
