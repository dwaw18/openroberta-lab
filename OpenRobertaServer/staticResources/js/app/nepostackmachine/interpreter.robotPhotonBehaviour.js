...
define(["require", "exports", "./interpreter.aRobotBehaviour", "./interpreter.constants", "./interpreter.util"], function (require, exports, interpreter_aRobotBehaviour_1, C, U) {
    ...
    var RobotPhotonBehaviour = /** @class */ (function (_super) {
        ...
        RobotPhotonBehaviour.prototype.getConnectedBricks = function () {
            var brickids = [];
        ...
        RobotPhotonBehaviour.prototype.getBrickIdByName = function (name) {
            for (var brickid in this.wedo) {
                if (this.wedo.hasOwnProperty(brickid)) {
        ...
        RobotPhotonBehaviour.prototype.getBrickById = function (id) {
            return this.wedo[id];
        };
        RobotPhotonBehaviour.prototype.clearDisplay = function () {
            U.debug('clear display');
            this.toDisplayFct({ "clear": true });
        };
        RobotPhotonBehaviour.prototype.getSample = function (s, name, sensor, port, slot) {
        ...
        RobotPhotonBehaviour.prototype.getSensorValue = function (wedoId, port, sensor, slot) {
        ...
        RobotPhotonBehaviour.prototype.finalName = function (notNormalized) {
        ...
        RobotPhotonBehaviour.prototype.timerReset = function (port) {
            this.timers[port] = Date.now();
            U.debug('timerReset for ' + port);
        };
        RobotPhotonBehaviour.prototype.timerGet = function (port) {
            var now = Date.now();
        ...
        RobotPhotonBehaviour.prototype.ledOnAction = function (name, port, color) {
        ...
        RobotPhotonBehaviour.prototype.statusLightOffAction = function (name, port) {
            var brickid = this.getBrickIdByName(name);
            var robotText = 'robot: ' + name + ', port: ' + port;
        ...
        RobotPhotonBehaviour.prototype.toneAction = function (name, frequency, duration) {
        ...
        RobotPhotonBehaviour.prototype.motorOnAction = function (name, port, duration, speed) {
            var brickid = this.getBrickIdByName(name); // TODO: better style
            var robotText = 'robot: ' + name + ', port: ' + port;
        ...
        RobotPhotonBehaviour.prototype.motorStopAction = function (name, port) {
            var brickid = this.getBrickIdByName(name); // TODO: better style
            var robotText = 'robot: ' + name + ', port: ' + port;
        ...
        RobotPhotonBehaviour.prototype.showTextAction = function (text, _mode) {
            var showText = "" + text;
            U.debug('***** show "' + showText + '" *****');
            this.toDisplayFct({ "show": showText });
            return 0;
        };
        RobotPhotonBehaviour.prototype.showImageAction = function (_text, _mode) {
            U.debug('***** show image not supported by WeDo *****');
            return 0;
        };
        RobotPhotonBehaviour.prototype.displaySetBrightnessAction = function (_value) {
            return 0;
        };
        RobotPhotonBehaviour.prototype.displaySetPixelAction = function (_x, _y, _brightness) {
            return 0;
        };
        RobotPhotonBehaviour.prototype.writePinAction = function (_pin, _mode, _value) {
        };
        RobotPhotonBehaviour.prototype.close = function () {
        ...
        RobotPhotonBehaviour.prototype.encoderReset = function (_port) {
            throw new Error("Method not implemented.");
        };
        RobotPhotonBehaviour.prototype.gyroReset = function (_port) {
            throw new Error("Method not implemented.");
        };
        RobotPhotonBehaviour.prototype.lightAction = function (_mode, _color, _port) {
            throw new Error("Method not implemented.");
        };
        RobotPhotonBehaviour.prototype.playFileAction = function (_file) {
            throw new Error("Method not implemented.");
        };
        RobotPhotonBehaviour.prototype._setVolumeAction = function (_volume) {
            throw new Error("Method not implemented.");
        };
        RobotPhotonBehaviour.prototype._getVolumeAction = function (_s) {
            throw new Error("Method not implemented.");
        };
        RobotPhotonBehaviour.prototype.setLanguage = function (_language) {
            throw new Error("Method not implemented.");
        };
        RobotPhotonBehaviour.prototype.sayTextAction = function (_text, _speed, _pitch) {
            throw new Error("Method not implemented.");
        };
        RobotPhotonBehaviour.prototype.getMotorSpeed = function (_s, _name, _port) {
            throw new Error("Method not implemented.");
        };
        RobotPhotonBehaviour.prototype.setMotorSpeed = function (_name, _port, _speed) {
            throw new Error("Method not implemented.");
        };
        ...
        RobotPhotonBehaviour.prototype.displaySetPixelBrightnessAction = function (_x, _y, _brightness) {
            throw new Error("Method not implemented.");
        };
        RobotPhotonBehaviour.prototype.displayGetPixelBrightnessAction = function (_s, _x, _y) {
            throw new Error("Method not implemented.");
        };
        RobotPhotonBehaviour.prototype.setVolumeAction = function (_volume) {
            throw new Error("Method not implemented.");
        };
        RobotPhotonBehaviour.prototype.getVolumeAction = function (_s) {
            throw new Error("Method not implemented.");
        };
        RobotPhotonBehaviour.prototype.debugAction = function (_value) {
            this.showTextAction("> " + _value, undefined);
        };
        RobotPhotonBehaviour.prototype.assertAction = function (_msg, _left, _op, _right, _value) {
            if (!_value) {
                this.showTextAction("> Assertion failed: " + _msg + " " + _left + " " + _op + " " + _right, undefined);
            }
        };
        return RobotPhotonBehaviour;
    }(interpreter_aRobotBehaviour_1.ARobotBehaviour));
    exports.RobotPhotonBehaviour = RobotPhotonBehaviour;
});
